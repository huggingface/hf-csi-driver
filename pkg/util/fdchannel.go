...
// SendMsg sends a file descriptor and a message over a Unix domain socket
// using SCM_RIGHTS ancillary data. The receiver can use RecvMsg to obtain
// a copy of the file descriptor in its own process.
